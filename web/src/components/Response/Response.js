...
import ResponsesCell from '../ResponsesCell/ResponsesCell'
      ...
      <div className="maxy relative m-2 flex flex-col justify-between rounded-lg bg-white p-8 shadow dark:border-emerald-300 dark:bg-zinc-900">
        ...
        <div className=" mt-3 flex w-full justify-center">
          <button
            ...
            className="bg-white-100 m-2 flex items-center rounded-lg p-2 shadow transition-shadow hover:bg-yellow-100 hover:ring hover:ring-yellow-500 focus:bg-yellow-100 focus:ring focus:ring-yellow-500 dark:border-emerald-200 dark:hover:bg-neutral-800"
          >
          ...
          <button
            ...
            className="m-2 flex items-center rounded-lg p-2  shadow transition-shadow hover:bg-red-100 hover:ring hover:ring-red-500 focus:bg-red-100 focus:ring focus:ring-red-500 dark:border-emerald-200 dark:hover:bg-neutral-800"
          >
            <div className=" flex flex-col">
              {/* <h1 className="m-2 text-4xl font-black text-black">Pennywrite</h1> */}
          ...
          <button
            ...
            className="m-2 flex items-center rounded-lg p-2  shadow transition-shadow hover:bg-green-100 hover:ring hover:ring-green-500 focus:bg-green-100 focus:ring focus:ring-green-500 dark:border-emerald-200 dark:hover:bg-neutral-800"
          >
            <div className=" flex flex-col">
              {/* <h1 className="m-2 text-4xl font-black text-black">Pennywrite</h1> */}
