...
const AllPrompts = ({ prompt }) => {
  return (
    ...
    >
      <div className="p2 z-10 my-5 mx-auto flex w-max max-w-md bg-white hover:bg-emerald-100 dark:bg-neutral-900 items-center gap-4 rounded-lg text-center shadow dark:hover:bg-neutral-800">
